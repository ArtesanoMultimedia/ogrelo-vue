        ...
        <div>
            ...
            <table v-if="!loading" width="100%" class="table table-striped table-bordered table-hover" id="reservas">
                ...
                <tbody v-if="reservasFiltradas !== []">
                    <tr v-for="reserva in reservasFiltradas" :id="reserva.id" class="odd gradeX">
...
<!--                          <form id="form" action="{{ form_action }}" method="{{ form_method }}">-->
                              <form id="form">
                                ...
                                <div id="group-telefono" class="form-group">
                                    ...
                                    <input v-model="reserva.telefono" class="form-control">
                                    <div id="error-telefono" class="alert alert-danger mt-2 collapse" role="alert"></div>
                                </div>
                                <div id="group-fecha" class="form-group">
                                    <label for="fecha" class="control-label">Fecha</label>
                                    <input v-model="reserva.fecha" class="form-control" autocomplete="off" placeholder="yyyy-mm-dd H:i" >
    ...
    methods: {
        ...
        store: function(id) {
            this.$store.dispatch('storeReserva', id);
    ...
    computed: {
        ...
        ...Vuex.mapState(['reserva', 'loading', 'reservas'])
    }
});
